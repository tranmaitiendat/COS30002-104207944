...
class GameWindow(pyglet.window.Window):
	...
	def __init__(self, **kwargs):
		...
		self.labels = {
			"Prey's status":	    pyglet.text.Label('', x=50, y=self.height-20, color=COLOUR_NAMES['WHITE']),
			"Prey's max speed":	    pyglet.text.Label('', x=350, y=self.height-20, color=COLOUR_NAMES['WHITE']),
			"Prey's mass":	        pyglet.text.Label('', x=650, y=self.height-20, color=COLOUR_NAMES['WHITE']),
   
			"Hunter's status":	    pyglet.text.Label('', x=50, y=20, color=COLOUR_NAMES['WHITE']),
			"Hunter's max speed":	pyglet.text.Label('', x=350, y=20, color=COLOUR_NAMES['WHITE']),
			"Hunter's mass":	    pyglet.text.Label('', x=650, y=20, color=COLOUR_NAMES['WHITE']),
		}
