...
class GameWindow(pyglet.window.Window):
	...
	def __init__(self, **kwargs):
		...
		self.labels = {
			'world mode':	pyglet.text.Label('', x=40, y=self.height-20, color=COLOUR_NAMES['WHITE']),
			'max speed':	pyglet.text.Label('', x=240, y=20, color=COLOUR_NAMES['WHITE']),
			'mass':	pyglet.text.Label('', x=450, y=20, color=COLOUR_NAMES['WHITE']),
			'agents number':	pyglet.text.Label('', x=750, y=20, color=COLOUR_NAMES['WHITE']),
			'chosen index':		pyglet.text.Label('', x=250, y=20, color=COLOUR_NAMES['WHITE']),
			'chosen near range':		pyglet.text.Label('', x=500, y=self.height-20, color=COLOUR_NAMES['WHITE']),
			'chosen far range':		pyglet.text.Label('', x=900, y=self.height-20, color=COLOUR_NAMES['WHITE']),
		}
