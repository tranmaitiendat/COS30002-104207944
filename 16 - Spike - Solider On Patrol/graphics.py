...
class GameWindow(pyglet.window.Window):
	...
	def __init__(self, **kwargs):
		...
		self.labels = {
			'hunter mode':	pyglet.text.Label('', x=40, y=self.height-20, color=COLOUR_NAMES['WHITE']),
			'hunter state':	pyglet.text.Label('', x=40, y=20, color=COLOUR_NAMES['WHITE']),
			'hunter travelled':	pyglet.text.Label('', x=440, y=20, color=COLOUR_NAMES['WHITE']),
			'prey health':	pyglet.text.Label('', x=840, y=self.height-20, color=COLOUR_NAMES['WHITE']),
		}
